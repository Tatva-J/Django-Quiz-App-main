      ...
      if (ele[i].checked) {
        ...
        if (checked_val == answerLabel.value) {
          ...
          if (document.getElementById("totalScore").value) {
            userScore = parseInt(document.getElementById("totalScore").value)
            console.log("Seeing the userscore value of last asnwer input", userScore);
            userScore += parseInt(points.value);
            // score = Number(totalScore.value) + userScore;
            sessionStorage.setItem("userScore", userScore);
            console.log(userScore);
            document.getElementById("totalScore").value = userScore
          } else {
            userScore += parseInt(points.value);
            score = Number(totalScore.value) + userScore;
